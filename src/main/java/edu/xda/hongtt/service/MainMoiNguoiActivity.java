...
public class MainMoiNguoiActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moi_nguoi_main);
    ...
    private void initEvents(Toolbar toolbar) {
        drawer = findViewById(R.id.drawer_moi_nguoi_layout);
        navigationView = findViewById(R.id.nav_moi_nguoi_view);
    ...
    public void onBackPressed() {
        DrawerLayout drawer = findViewById(R.id.drawer_moi_nguoi_layout);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.activity_main_moi_nguoi, menu);
        return true;
    }
...
//        }
    ...
    public void thongBaoCloseApp(){
        AlertDialog.Builder builder = new AlertDialog.Builder(MainMoiNguoiActivity.this);
        ...
        builder.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        SharedPreferences sharedPreferences = getSharedPreferences("MyAppPrefs", Context.MODE_PRIVATE);
                        String tenDangNhap = sharedPreferences.getString("username",null);
                        MyDatabaseHelper db = new MyDatabaseHelper(MainMoiNguoiActivity.this);
        ...
        builder.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Intent intent = new Intent(MainMoiNguoiActivity.this , LoginActivity.class);
                        startActivity(intent);
                        dialog.cancel();
                    }
                });
